...
VALUES ('PHARMACIST');
INSERT INTO ROLE (name)
VALUES ('PHARMACY_ADMIN');
INSERT INTO ROLE (name)
VALUES ('SUPPLIER');

/*Locations*/
insert into location (longitude, latitude)
values (19.833549, 45.267136); /*Novi Sad*/
insert into location (longitude, latitude)
values (20.43157, 44.80886); /*Beograd*/
insert into location (longitude, latitude)
values (19.8419405, 45.2474401);

/*Addresses*/
insert into address (street, city, country, location_id)
values ('Omladinska 19', 'Novi Sad', 'Srbija', 1);
insert into address (street, city, country, location_id)
values ('Jevrejska 4', 'Beograd', 'Srbija', 2);
insert into address (street, city, country, location_id)
values ('Bulevar kralja Aleksandra 37', 'Beograd', 'Srbija', 2);
insert into address (street, city, country, location_id)
values ('Fruskogorksa 14', 'Novi Sad', 'Srbija', 1);
insert into address (street, city, country, location_id)
values ('Bulevar oslobodjenja 119', 'Novi Sad', 'Srbija', 3);

/*Medicine types*/
insert into medicine_type (name)
values ('Antibiotik');
insert into medicine_type (name)
values ('Anestetik');

/*Medicine forms*/
insert into medicine_form (name)
values ('Šumeće granule');
insert into medicine_form (name)
values ('Sirup');
insert into medicine_form (name)
values ('Komprimovana lozenga');
insert into medicine_form (name)
values ('Film tableta');

/*Manufacturers*/
insert into manufacturer (name)
values ('ABBVIE S.R.L. - Italija');
insert into manufacturer (name)
values ('GALENIKA AD BEOGRAD - Republika Srbija');
insert into manufacturer (name)
values ('BOSNALIJEK D.D. - Bosna i Hercegovina');
insert into manufacturer (name)
values ('IL CSM CLINICAL SUPPLIES MANAGEMENT - Nemačka');
insert into manufacturer (name)
values ('ANPHARM PRZEDSIEBIORSTWO FARMACEUTYCZNE S.A. - Poljska');
...
insert into medicine (name, code, content, side_effects, daily_intake, recipe_required, additional_notes, avg_grade,
                      points, medicine_type_id, medicine_form_id, manufacturer_id)
values ('Paracetamol', 'M02AE01', 'Nema podataka.', 'Moze doci do ozbiljnih problema.', 2, 'REQUIRED', 'Nema', 4.5, 20,
        2, 2, 2);
...
values ('Lysobact', 'R02AA', 'Nema podataka.',
        ...
        7, 'NOTREQUIRED', 'Uobičajena doza je 6 do 8 komprimovanih lozengi tokom dana.',
        3.9, 5, 2, 3, 3);

insert into medicine (name, code, content, side_effects, daily_intake, recipe_required, additional_notes, avg_grade,
                      points, medicine_type_id, medicine_form_id, manufacturer_id)
values ('Kytril', 'A04AA02', 'Nema podataka.',
        'Kod pacijenata koji su prethodno imali aritmije ili poremećaje u srčanoj provodljivosti, ovo može dovesti do kliničkih posledica.',
        2, 'REQUIRED',
        '1 mg dva puta na dan ili 2 mg jednom dnevno tokom perioda do nedelju dana nakon radioterapije ili hemioterapije. ',
        2.8, 15, 2, 4, 4);

insert into medicine (name, code, content, side_effects, daily_intake, recipe_required, additional_notes, avg_grade,
                      points, medicine_type_id, medicine_form_id, manufacturer_id)
values ('Prexanil', 'C09BA04', 'Nema podataka.',
        'Nema podataka.', 2, 'REQUIRED',
...
/*Order items*/
insert into order_item (amount, medicine_id)
values (50, 2);
insert into order_item (amount, medicine_id)
values (150, 2);
insert into order_item (amount, medicine_id)
...
/*WorkDays*/
insert into work_day (weekday, start_time, end_time)
values ('MON', 8, 16);
insert into work_day (weekday, start_time, end_time)
values ('TUE', 8, 16);
insert into work_day (weekday, start_time, end_time)
...
/*MyUsers*/
insert into my_user (password, first_name, last_name, email, telephone, role_id, address_id, is_password_changed,
                     is_email_verified)
...
/*Pharmacy Workers*/
insert into pharmacy_worker (avg_grade, id)
values (4.8, 6);
insert into pharmacy_worker (avg_grade, id)
values (4.8, 7);
insert into pharmacy_worker (avg_grade, id)
...
/*Patients*/
insert into patient (points, penalties, id)
values (50, 2, 1);
insert into patient (points, penalties, id)
values (43, 0, 2);
insert into patient (points, penalties, id)
...
/*Supplier items*/
insert into supplier_item (amount, medicine_id, supplier_id)
values (30, 1, 5);
insert into supplier_item (amount, medicine_id, supplier_id)
values (20, 2, 5);
insert into supplier_item (amount, medicine_id, supplier_id)
...
/*Ratings*/
insert into rating (grade, graded_type, gradedId, date, patient_id)
values (4, 'MEDICINE', 1, 1616510769000, 1);
insert into rating (grade, graded_type, gradedId, date, patient_id)
values (5, 'MEDICINE', 3, 1616586369000, 2);
insert into rating (grade, graded_type, gradedId, date, patient_id)
values (5, 3, 6, 1616586369000, 1);
insert into rating (grade, graded_type, gradedId, date, patient_id)
values (4, 3, 7, 1616586369000, 1);

/*RankingCategory*/
insert into ranking_category (name, points_required, discount)
values ('Bronza', 50, 5.0);
insert into ranking_category (name, points_required, discount)
values ('Srebro', 100, 15.0);
insert into ranking_category (name, points_required, discount)
values ('Zlato', 200, 30.0);

/*Medicine Prices*/
insert into medicine_price (price, start_date)
values (449, 1618077600000);
insert into medicine_price (price, start_date)
values (489, 1618160400000);
insert into medicine_price (price, start_date)
values (250, 1615482000000);
insert into medicine_price (price, start_date)
values (670, 1613062800000);
insert into medicine_price (price, start_date)
values (1200, 1610384400000);

insert into medicine_price (price, start_date)
values (470, 1578769200000);
insert into medicine_price (price, start_date)
values (470, 1578769200000);
insert into medicine_price (price, start_date)
values (410, 1616241600000);
insert into medicine_price (price, start_date)
values (1345, 1616241600000);
insert into medicine_price (price, start_date)
values (233, 1616241600000);

insert into medicine_price (price, start_date)
values (459, 1616241600000);
insert into medicine_price (price, start_date)
values (467, 1616241650000);
insert into medicine_price (price, start_date)
values (278, 1616241600000);
insert into medicine_price (price, start_date)
values (845, 1616241600000);
insert into medicine_price (price, start_date)
values (640, 1616241600000);

insert into medicine_price (price, start_date)
values (700, 1616241600000);


/*Complaints*/
insert into complaint (content, complaint_on, complaint_on_id, type, state, date, patient_id)
values ('Nije ispostovan dogovor, trazim da bude sankcionisan.', 'Nebojsa Radovanovic', 5, 'PHARMACIST', 'RESOLVED',
        1616587200000, 1);
insert into complaint (content, complaint_on, complaint_on_id, type, state, date, patient_id)
...
insert into pharmacy (avg_grade, consultation_price, consultation_duration, description, name, points, address_id)
values (4.8, 450, 10,
        'Poverenje, sigurnost i dostupnost su, već skoro 30 godina, glavna obeležja Apotekarske ustanove Jankovic.',
        'Apoteka Jankovic', 10, 1);
insert into pharmacy (avg_grade, consultation_price, consultation_duration, description, name, points, address_id)
values (2.9, 200, 5,
        'Poručite sve što vam je potrebno na vašu kućnu adresu. Imas veliki izbor i sjajanu cenu samo na BENU online shop-u.',
        'Benu Apoteka', 15, 2);


/*Price Lists*/
insert into price_list (pharmacy_id)
values (1);
insert into price_list (pharmacy_id)
values (2);
insert into price_list (pharmacy_id)
...
/*Medicine items*/
insert into medicine_item (amount, medicine_id, price_list_id)
values (18, 1, 1);
insert into medicine_item (amount, medicine_id, price_list_id)
values (25, 2, 1);
insert into medicine_item (amount, medicine_id, price_list_id)
...
insert into medicine_item_medicine_prices (medicine_item_id, medicine_prices_id)
values (1, 1);
insert into medicine_item_medicine_prices (medicine_item_id, medicine_prices_id)
values (1, 2);
insert into medicine_item_medicine_prices (medicine_item_id, medicine_prices_id)
...
insert into pharmacy_subscribers (pharmacy_id, subscribers_id)
values (1, 1);
insert into pharmacy_subscribers (pharmacy_id, subscribers_id)
values (2, 1);
insert into pharmacy_subscribers (pharmacy_id, subscribers_id)
...
/*Workplaces*/
insert into workplace (pharmacy_id, worker_id)
values (1, 6); /* Farmaceut */
insert into workplace (pharmacy_id, worker_id)
values (1, 7); /* Dermatolog */
insert into workplace (pharmacy_id, worker_id)
values (2, 7); /* Dermatolog */
insert into workplace (pharmacy_id, worker_id)
values (2, 14); /* Dermatolog */
insert into workplace (pharmacy_id, worker_id)
values (2, 15); /* Farmaceut */
insert into workplace (pharmacy_id, worker_id)
values (2, 16); /* Farmaceut */
insert into workplace (pharmacy_id, worker_id)
values (3, 17); /* Farmaceut */
insert into workplace (pharmacy_id, worker_id)
values (3, 18); /* Farmaceut */
insert into workplace (pharmacy_id, worker_id)
values (3, 14);
/* Dermatolog */
...
insert into workplace_work_days (workplace_id, work_days_id)
values (1, 1);
insert into workplace_work_days (workplace_id, work_days_id)
values (1, 2);
insert into workplace_work_days (workplace_id, work_days_id)
...
insert into appointment (appointment_state, appointment_type, duration, start_time, end_time, info, price, patient_id,
                         pharmacy_id, worker_id, reservation_discount)
...
values ('FINISHED', 'CONSULTATION', 2, 1613466603000, 1613466693000, 'Placanje u unapred.', 1700, 3, 1, 6, 0);
insert into appointment (appointment_state, appointment_type, duration, start_time, end_time, info, price, patient_id, pharmacy_id, worker_id, reservation_discount)
values ('FINISHED', 'CONSULTATION', 2, 1613466603000, 1613466903000, 'Placanje u unapred.', 1700, 3, 1, 6, 0);
insert into appointment (appointment_state, appointment_type, duration, start_time, end_time, info, price, patient_id, pharmacy_id, worker_id, reservation_discount)
values ('FINISHED', 'CONSULTATION', 2, 1621156203000, 1621156703000, 'Placanje u unapred.', 1700, 3, 1, 6, 0);
insert into appointment (appointment_state, appointment_type, duration, start_time, end_time, info, price, patient_id, pharmacy_id, worker_id, reservation_discount)
values ('FINISHED', 'CONSULTATION', 2, 1621156203000, 1621156503000, 'Placanje u unapred.', 1700, 3, 1, 6, 0);
insert into appointment (appointment_state, appointment_type, duration, start_time, end_time, info, price, patient_id, pharmacy_id, worker_id, reservation_discount)
values ('FINISHED', 'CONSULTATION', 2, 1621156203000, 1621156263000, 'Placanje u unapred.', 1700, 3, 1, 6, 0);
...
/*MyOrders*/
insert into my_order (admin_id, deadline, pharmacy_id, order_state)
values (9, 1620817200000, 1, 'IN_PROGRESS');
insert into my_order (admin_id, deadline, pharmacy_id, order_state)
values (9, 1620903600000, 2, 'IN_PROGRESS');
insert into my_order (admin_id, deadline, pharmacy_id, order_state)
values (9, 1620817200000, 1, 'IN_PROGRESS');
insert into my_order (admin_id, deadline, pharmacy_id, order_state)
values (9, 1620817200000, 1, 'IN_PROGRESS');
...
values (9, 1620817200000, 1, 'IN_PROGRESS');
insert into my_order (admin_id, deadline, pharmacy_id, order_state)
values (9, 1613411940000, 1, 'ON_HOLD');
insert into my_order (admin_id, deadline, pharmacy_id, order_state)
values (9, 1624652935000, 1, 'IN_PROGRESS');
insert into my_order (admin_id, deadline, pharmacy_id, order_state)
values (9, 1624652935000, 3, 'IN_PROGRESS');

/*MyOrders - OrderItems*/
insert into my_order_order_item (my_order_id, order_item_id)
values (1, 1);
insert into my_order_order_item (my_order_id, order_item_id)
values (1, 4);
insert into my_order_order_item (my_order_id, order_item_id)
...
/*Supplier - Offers*/
insert into supplier_offers (supplier_id, offers_id)
values (5, 1);
insert into supplier_offers (supplier_id, offers_id)
values (4, 2);
insert into supplier_offers (supplier_id, offers_id)
...
/*ERecipe Items*/
insert into erecipe_item (medicine_code, medicine_name, quantity)
values ('M01AE01', 'Brufen', 2);
insert into erecipe_item (medicine_code, medicine_name, quantity)
values ('N02BE01', 'Paracetamol', 1);

/*ERecipes*/
insert into erecipe (prescription_date, dispensing_date, state, code, total_price, total_price_with_discount,
                     patient_id, pharmacy_id)
values (1616846400000, 1620812258708, 'PROCESSED', 'EP0000', 1228.0, 1228.0, 1, 1);

/*ERecipes - ERecipes Items*/
insert into erecipe_e_recipe_items (erecipe_id, e_recipe_items_id)
values (1, 1);
insert into erecipe_e_recipe_items (erecipe_id, e_recipe_items_id)
values (1, 2);
...
insert into patient_medicine_reservation (patient_id, medicine_reservation_id)
values (1, 1);
insert into patient_medicine_reservation (patient_id, medicine_reservation_id)
values (1, 2);
insert into patient_medicine_reservation (patient_id, medicine_reservation_id)
...
insert into medicine_alternative_medicine (medicine_id, alternative_medicine_id)
values (1, 2);
insert into medicine_alternative_medicine (medicine_id, alternative_medicine_id)
values (2, 1);
insert into medicine_alternative_medicine (medicine_id, alternative_medicine_id)
...
insert into pharmacy_admins (pharmacy_id, admins_id)
values (1, 9);

/*Inquiries*/
insert into inquiry (pharmacy_id, worker_id, medicine_items_id, is_active, date)
values (1, 6, 7, true, 1619974515000);
insert into inquiry (pharmacy_id, worker_id, medicine_items_id, is_active, date)
values (1, 6, 1, false, 1617382515000);
insert into inquiry (pharmacy_id, worker_id, medicine_items_id, is_active, date)
values (1, 7, 2, false, 1617382515000);
insert into inquiry (pharmacy_id, worker_id, medicine_items_id, is_active, date)
values (1, 7, 1, false, 1617382515000);
insert into inquiry (pharmacy_id, worker_id, medicine_items_id, is_active, date)
values (1, 6, 2, false, 1617382515000);
