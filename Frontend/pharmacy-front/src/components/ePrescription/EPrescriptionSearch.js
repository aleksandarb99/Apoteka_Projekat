...
const ERecipeSearch = () => {
    ...
    const doBuy = (id) => {
        api.post(`http://localhost:8080/api/e-recipes/dispense-medicine/${id}`, parsedData)
            .then(() => {
                alert("Success")
                setParsedData([])
            })
    ...
    return (
        <Container>
            ...
            <PharmacyWithMedicineList pharmacies={pharmacies} doBuy={(id) => { doBuy(id) }}> </PharmacyWithMedicineList>
        </Container>
