...
const TherapyMedicineModal = (props) => {
    ...
    return (
        <Modal {...props} aria-labelledby="contained-modal-title-vcenter" centered scrollable onHide={exitModal}>
            ...
            <Modal.Body>
                <Form onSubmit={handleSubmit}>
                    ...
                    <Row className='justify-content-center mb-4'>
                        <Button variant="primary" onClick={()=>setShowHidePrimary(!showHidePrimary)}>Show/Hide info</Button>
                    </Row>
                    ...
                    {(singleSelection.length > 0 && showHidePrimary) &&
                        <Col style={{backgroundColor: "#83CEC2"}}>
                            ...
                            <Row className='m-2'>
                                -Code: {singleSelection[0].code}
                            </Row>
                            <Row className='m-2'>
                                -Name: {singleSelection[0].name}
                            </Row>
                            <Row className='m-2'>
                                -Price: {singleSelection[0].price}
                            </Row>
                            <Row className='m-2'>
                                -Content: {singleSelection[0].content}
                            </Row>
                            <Row className='m-2'>
                    ...
                    {(alternativeSelection.length > 0 && showHideSecondary) &&
                        <Col style={{backgroundColor: "#83CEC2"}}>
                            ...
                            <Row className='m-2'>
                                -Code: {alternativeSelection[0].code}
                            </Row>
                            <Row className='m-2'>
                                -Name: {alternativeSelection[0].name}
                            </Row>
                            <Row className='m-2'>
                                -Price: {alternativeSelection[0].price}
                            </Row>
                            <Row className='m-2'>
                    ...
                    <Row className='mb-2 mt-5 ml-2'>
                        Selected medicine: {selectedMedicine ? selectedMedicine.name : '- none selected -'}
                    </Row>
                    ...
                    <Button variant="secondary" onClick={exitModal}>Cancel</Button>
                </Form>
            </Modal.Body>
        </Modal>
    )
