        ...
        <Row className="justify-content-center mt-5 ml-5 mr-5 pb-5 align-items-center">
            <Col md={4} className="card_appt_home" style={{backgroundColor: 'white'}}>
                <Row className="justify-content-center m-5 align-items-center">
                    <h3 className="my_content_header" style={{textAlign: 'center'}}>Working hours</h3>
                </Row>
                <Row className="justify-content-center m-5 align-items-center">
                    <InputGroup>
                        <InputGroup.Prepend>
                ...
                {(workplaces[currSelect]?.workDayList ? workplaces[currSelect].workDayList : []).map((value, index) => {
                    return (
                        <Row className="justify-content-center p-2 m-2 align-items-center" style={{backgroundColor: "#83CEC2"}}>
